...
<html>
<head>
<script src="/srb/staticContent/JS/Class_Division.js"></script>
...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row header_margin_top">
			<div align="center">
				<h2 class="form-name style_heading" style="margin-top: 80px">Class Division Association</h2>
			</div>
		</div>
...
<form class="form-horizontal">
			...
			<div class="container" align="center">
				<input type="button" class="btn btn-success btn-lg" value="Save" onclick="ClassDivisionAssoc()"> 
