 ...
 <script type="text/javascript" src="/srb/staticContent/JS/cashbook.js"></script>
  <script src="/srb/staticContent/JS/Student.js"></script>
   ...
   <script type="text/javascript">
		function back()
		{
			window.location="SportsCertificate.jsp";
                ...
                <section class="content-header">
                    ...
                    <div class="p-l-30 p-r-30">
                        ...
                        <div class="header-title">
                            <h1>Duplicate Sport Certificate</h1>
				...
				<div class="form-group">
					...
					<div class="col-md-3">
						<div class="input-group">
							...
							<input list="classes" id="fk_class_id1" class="form-control" onchange="getDivisionNameByClassNameCopyBonafide()">
							<datalist id="classes">
							 <%
...
<%-- 
							...
							<option data-value="<%=sup.getPkDivisionId()%>"
								...
								<%
									...
									%>onchange="getStudentDetailsAsPerClassAdDivision()"
 			...
 			<div class="form-group">
 					...
 					<label class="col-md-2 col-sm-offset-1 control-label"  align="right">Student Name:<sup>*</sup>
										...
										<div class="input-group">
											...
											<select id="fk_Student_id"  name="studentNa" class="form-control">
											</select>
           							 </div>
								</div>
	 		 ...
	 		 <div class="form-group row">
                                <div class="col-md-offset-4 col-md-4 btn-center">
                                    ...
                                    <input type="button" class="ui positive button" name="btn" onclick="CopySportCertificateGenerator()" value="Print">
