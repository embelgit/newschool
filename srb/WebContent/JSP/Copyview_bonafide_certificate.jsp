...
<%
	...
	try {
		...
		ResultSet rs = stmt.executeQuery("SELECT first_name,middle_name,last_name,city,taluka,district,cast,date_of_birth,c.class_name AS className FROM student_master LEFT JOIN class_master c ON fk_class_id = c.pk_class_id WHERE pk_student_id="+studentId);
	/* 	while (rs.next()) {
		...
		tableThird.setWidthPercentage(80);
...
/* 		//seventh table for note
		...
		table_cellEight = new PdfPCell(new Phrase("Genral Register No:-",font13));
