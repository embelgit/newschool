    ...
    <div class="col-sm-12">
        <div class="panel panel-default thumbnail">
           ...
           <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-primary"  onclick="Back()" accesskey="t""> <i class="fa fa-list"></i>Sport List</a>  
                    </div>
         ...
         <form class="form-horizontal" method="post" action="" name="delsport">  <!-- Value of 'name' attribute is used in categoryDetails.js  -->
			 ...
			 <div class="row form-group">
           		<label class="col-md-offset-3 col-md-2 control-label" for="godown">Select Field To Delete:<sup>*</sup></label>  
            			...
            			<div class="input-group">
							...
							List list18 = dao.getAllSporttoDelete();

							%>
							
							<input list="dels_drop2" id="delsport1"  class="form-control">
				            <datalist id="dels_drop2">
					
							<%
							 for(int i=0;i<list18.size();i++){
								 SportInfoHibernate sp1 =(SportInfoHibernate)list18.get(i);


							%>
		
								<option data-value="<%=sp1.getPkSportId()%>"value="<%=sp1.getCreateactivity()%>">
							<%
				      			}
				    		%>
						</datalist>        
