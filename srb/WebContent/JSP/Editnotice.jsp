						...
						<div class="input-group">
							...
							<option data-value="<%=sup.getPkDivisionId()%>"
								...
								<%
									...
									%>
							onchange="getGridOfStudentForCheckUp() 
							</datalist> --%>
							
							<input list="division" id="fk_division_id" class="form-control" onchange="getnoticeDetails();">
			...
			<div class="row">
					...
					<div class="col-sm-3">
						<div class="input-group">
							...
							<i class="glyphicon glyphicon-calendar"></i>
							 ...
							 <input type="date" id='noticeDatee' name="noticeDatee" class="form-control" >
						</div>
					</div>
				</div>
				</div>
			 ...
			 <div class="row" style="display: none;">
				<div class="form-group">
					...
					<div class="col-sm-2" align="right">
						<label class="control-label">Pk ID :<sup>*</sup></label>
					</div>
					<div class="col-sm-3">
						<div class="input-group">
							<span class="input-group-addon">
							<i class="glyphicon glyphicon-calendar"></i>
							 ...
							 <input type="text" id='pkid' name="pkid" class="form-control"  >
						</div>
					</div>
				</div>
				</div> 
			...
			<div class="row form-group">
			 ...
			 <div class="form-group row">
                                <div class="col-md-offset-4 col-md-4 btn-center">
                                    ...
                                    <input type="button" class="ui positive button" name="btn" value="Update" onclick="editnotice()">Save</button>
