...
function edithome(){
	 window.location = "edithomework.jsp";
}

function edithome1(){
//	alert("helo")
	 window.location = "edithome.jsp";
}
</script>
			...
			<div class="row">
			 ...
			 <div class="form-group row">
                                <div class="col-md-offset-4 col-md-4 btn-center">
                                    ...
                                    <button class="ui positive button" name="btn" value="Save" onclick="HomeWorkteacherDailyTaskEntry(); return false;">Save</button>
                                       
                                        <div class="or"></div>
                                         <button type="reset" class="ui button">Reset</button>
                                       <div class="or"></div>
<!--                                       <button class="ui positive button" name="btn" value="Edit" onclick="edithome1()">Edit</button>  -->
                       <input type="button"  class="ui positive button" name="btn" value="Edit" onclick="edithome1();"> 
                      
                   
                     <!--                 <input type="button" class="ui positive button" name="btn" value="Edit" onclick="edit1()" >Edit</button> --> 
                                       </div>
                                </div>
                            </div>
<!-- pop code -->
