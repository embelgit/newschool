...
<head>
	 ...
	 function editStudent() {
			 window.location = "editstudenthealth.jsp";
	}
...
<div class="content-wrapper" style="min-height: 1134px;">
        ...
        <div class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                ...
                <div class="btn-group"> 
                    <a class="btn btn-primary" onclick="studentCheckUpList()" accesskey="t""> <i class="fa fa-list"></i>Student CheckUp List </a>
                </div>
            </div>
            </div> 
                          ...
                          <input type="button" class="ui positive button" name="btn" value="Save" onclick="addStudentCheckUpInfo()" >Save</button>
                              ...
                              <div class="or"></div>
                               <button type="reset" class="ui button" onclick="location.reload()">Reset</button>
                                <div class="or"></div>
                              <input type="button" class="ui positive button" name="btn" value="Edit" onclick="editStudent()">Edit</button>
                              <!-- onclick="studentList()" -->
                               </div>
                      </div>
                  </div>
