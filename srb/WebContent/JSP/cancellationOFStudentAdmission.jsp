...
<div class="content-wrapper" style="min-height: 1134px;">
 ...
 <form class="form-horizontal" name="CancelAdminision">
 			<div class="row">
				<div class="form-group">
					...
					<div class="col-md-3">
						<div class="input-group">
							...
							<input list="classes" id="fk_class_id1" class="form-control" onchange="getDivisionNameByClassNameCancellationAdmission()">
							<datalist id="classes">
							 <%
 					...
 					<label class="col-md-2 col-sm-offset-1 control-label"  align="right">Student Name:<sup>*</sup></label>  
           							<div class="col-md-3">
										<div class="input-group">
											...
											<select id="fk_Student_id" class="form-control" onblur="getTotalAnnualFee()">
											</select>
           							 </div>
								</div> 
								<div class="col-md-3">
		 ...
		 <div class="form-group row">
                                <div class="col-md-offset-4 col-md-4 btn-center">
                                    ...
                                    <input type="button"  class="ui positive button" name="btn" value="Save" onclick="cancelAdmission()" style="width: 75px;">Save</button>
