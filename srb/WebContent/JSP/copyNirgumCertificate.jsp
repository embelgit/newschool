...
<head>
 <script type="text/javascript" src="/srb/staticContent/JS/cashbook.js"></script>
  <script src="/srb/staticContent/JS/Student.js"></script>
   <script src="/srb/staticContent/JS/nirgum.js"></script>
   ...
   function nirgumCertificate()
   {
	   window.location="copyNirgumCertificate.jsp";
   }
   </script>
...
<!--                 <div class=""> 
                    <a class=""    accesskey="t""> <i class="fa fa-list"></i>Copy</a>  
                </div> -->
				...
				<div class="form-group">
					...
					<div class="col-md-3">
						<div class="input-group">
							...
							<input list="classes" id="fk_class_id1" class="form-control" onchange="getDivisionNameByClassNameng()">
							<datalist id="classes">
							 <%
					...
					<div class="col-md-3">
						<div class="input-group">
							...
							<input list="division" id="fk_division_id" class="form-control" onchange="getStudentDetailsAsPerClassAdDivisionng()">
...
<!-- 					<div class="col-sm-2 col-sm-offset-1" align="right">
			...
			<div class="row">
				<div class="form-group"> 
					 <div class="col-sm-2 col-sm-offset-1" align="right">
						<label class="control-label">Nirgum date:<sup>*</sup></label>
					</div>
					<div class="col-md-3">
						<div class="input-group">
							<span class="input-group-addon">
						...
						<div class="col-sm-2" align="right">
						<label class="control-label">Place:<sup>*</sup></label>
					</div>
					<div class="col-md-3">
						<div class="input-group">
							<span class="input-group-addon">
						    ...
						    <input type="text" id="place" name="place" class="form-control"  value="ShankarNagar">
					 	</div>
					 </div>
