    ...
    <div class="col-sm-12">
        <div class="panel panel-default thumbnail">
           ...
           <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-primary"  onclick="Back()" accesskey="t""> <i class="fa fa-list"></i>Schedule Meeting List</a>  
                    </div>
         ...
         <form class="form-horizontal" method="post" action="" name="delstrpro12">  <!-- Value of 'name' attribute is used in categoryDetails.js  -->
		...
		<%-- 	<div class="row form-group">
			 ...
			 <div class="row form-group">
           		<label class="col-md-offset-3 col-md-2 control-label" for="godown">Select Field To Delete:<sup>*</sup></label>  
            			...
            			<div class="input-group">
							...
							List sList3 = sdd.getScheduleMeeting();
            ...
            <div class="form-group row">
                                <div class="col-md-offset-4 col-md-4 btn-center">
                                    ...
                                    <input type="button" class="ui positive button" name="btn" id="btn" value="Delete"  onclick="deleteScheduleMeeting2()" style="width: 95px;">
