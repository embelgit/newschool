...
<head>
  ...
  <script src="/srb/staticContent/JS/timeTable.js"></script>
                ...
                <section class="content-header">
                    ...
                    <div class="p-l-30 p-r-30">
                        ...
                        <div class="header-title">
                            ...
                            <small>Delete Daily Time Table</small> 
                        </div>
                    </div>
                </section>
    ...
    <div class="col-sm-12">
        <div class="panel panel-default thumbnail">
            ...
            <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-primary" onclick="Back()"  accesskey="t""> <i class="fa fa-list"></i>Add Time Table </a>  
                </div>
            </div> 
				...
				<div class="row">
	       			 <div class="row form-group">
           				 ...
           				 <label class="col-md-2 control-label col-sm-offset-1">Select Class:</label>  
							 ...
							 <%
							 DailyTimeTableDAO eedd = new DailyTimeTableDAO();
           						List mList =eedd.getAllclass();
							
							%>
						<input list="classId" id="fk_class_id"  class="form-control" onchange="getDivisionNameByClass()">
				<datalist id="classId">
							
							<%
					           for(int i=0;i<mList.size();i++){
					        	   DailyTimeTableHibernate detailsBean =(DailyTimeTableHibernate)mList.get(i);
							%>
		
						<option data-value="<%=detailsBean.getFkClassId()%>"><%=detailsBean.getClassName()%></option>
							<%
				      			}
				    		%>
						</datalist> 
