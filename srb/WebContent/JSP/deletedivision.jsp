...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row header_margin_top">
			<div align="center">
				<h2 class="form-name style_heading" style="margin-top: 80px">Delete Division</h2>
			</div>
		</div>
		<div class="row">
			...
			<div class="row form-group">
					...
					<div class="col-md-3">
						<div class="input-group">
							...
							<input list="classId" id="fk_class_id" class="form-control" onchange="getDivisionNameByClassNameDivision()">
							<datalist id="classId">
							 <%
		...
		<!-- 	<div class="container" align="center">
			...
			<div class="form-group row">
                                <div class="col-md-offset-4 col-md-4 btn-center">
                                    ...
                                    <input type="button" class="ui positive button" name="btn" value="Delete" onclick="deldivision()">Delete</button>
