    ...
    <div class="col-sm-12">
        <div class="panel panel-default thumbnail">
           ...
           <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-primary"  onclick="Back()" accesskey="t""> <i class="fa fa-list"></i>Hostel Inventory List</a>  
                    </div>
		...
		<%-- 	<div class="row form-group">
           		...
           		<label class="col-md-offset-3 col-md-2 control-label" for="godown">Select Product Name<sup>*</sup></label>  
            			...
            			<div class="input-group">
							...
							KitchenInventoryDao sdd = new KitchenInventoryDao();
           						List sList =sdd.getAllproducthostel();
							...
							<%
					           for(int i=0;i<sList.size();i++){
					        	   hostelmanagementhibernate sup =(hostelmanagementhibernate)sList.get(i);
							%>
		
							<option data-value="<%=sup.getPkhostelid() %>" value="<%=sup.getProductName()%>">					
							<%
				      			}
				    		%>
						</datalist>        
          ...
          <div class="form-group row">
                                <div class="col-md-offset-4 col-md-4 btn-center">
                                    ...
                                    <input type="button" class="ui positive button" name="btn" value="Delete" id="btn" onclick="delhostelproduct()" style="width: 95px;">
