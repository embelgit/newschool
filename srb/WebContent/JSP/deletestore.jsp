    ...
    <div class="col-sm-12">
        <div class="panel panel-default thumbnail">
           ...
           <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-primary"  onclick="Back()" accesskey="t""> <i class="fa fa-list"></i>Store Inventory List</a>  
                    </div>
		...
		<%-- 	<div class="row form-group">
			 ...
			 <div class="row form-group">
           		<label class="col-md-offset-3 col-md-2 control-label" for="godown">Select Product Name<sup>*</sup></label>  
            			...
            			<div class="input-group">
							...
							<%
							StoreManagementDAO sdd = new StoreManagementDAO();
							...
							<%
					           for(int i=0;i<sList.size();i++){
					        	   StoreManagementHibernate sup =(StoreManagementHibernate)sList.get(i);
							%>
		
							<option data-value="<%=sup.getPkStoreManagementId()%>" value="<%=sup.getProductName() %>">
							<%
				      			}
				    		%>
						</datalist>        
          ...
          <div class="form-group row">
                                <div class="col-md-offset-4 col-md-4 btn-center">
                                    ...
                                    <input class="ui positive button" name="btn" value="Delete" onclick="delstoreproduct()" style="width: 95px;">
