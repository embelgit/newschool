...
<div class="container-fluid">
		...
		<div class="row header_margin_top">
			<div align="center" style="margin-left: 310px;">
				<h2 class="form-name style_heading" style="margin-top: 80px">Edit Exam Time Table Details</h2>
			</div>
		</div>
			...
			<br><br><br>
                 <div class="form-group row" style="margin-left: 280px;">
                                <div class="col-md-offset-4 col-md-4 btn-center">
                                    ...
                                    <input type="button"  class="ui positive button btn large" name="btn" value="Update" onclick="editExamTimeTable1()">Save</button>
