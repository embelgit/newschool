		...
		<form class="form-horizontal">
			<div class="row">
				<div class="form-group">
					...
					<label class="control-label">Start Date:<sub>*</sub></label>
					</div>
					<div class="col-md-3">
					...
					<label class="control-label">End Date:<sub>*</sub></label>
					</div>
					<div class="col-md-3">
						<div class="input-group">
							<span class="input-group-addon">
				...
				<div class="form-group">
					<div class="col-sm-3 col-md-offset-5" >
							...
							<input type="button" class="btn btn-lg btn-success btn-md button_hw button_margin_right" name="btn" value="Search" onclick="validationKitchenInventoryBetweenTwoDate()">
			...
			<div id="dataTab">
			 <div class="table-responsive">
					<table class="table table-bordered table-striped table-condensed cf"
					 	id="kitchenInvRep" class="display"
