...
<div class="content-wrapper" style="min-height: 1134px;">
                ...
                <section class="content-header">
                    ...
                    <div class="p-l-30 p-r-30">
                        ...
                        <div class="header-title">
                            <h1>Library Payment List</h1>
                            <small>Library Payment List</small> 
                        </div>
                    </div>
                </section>
	...
	<%
		...
		List list12 = dao.getlibraryPaymentList();
	%>
		...
		<table id="list" class="table table-bordered display">
			...
			<tbody>
   				...
   				for(int i=0;i<list12.size();i++){
   					LibraryPaymentBean sr=(LibraryPaymentBean)list12.get(i);
				%>
				
				<tr>
				 	<td class="align"><%=k%></td>
					<td class="align"><%=sr.getSupplier() %></td>
