...
<script type="text/javascript" src="/srb/staticContent/CSS/dataTables.jqueryui.min.css"></script>
<script type="text/javascript" src="/srb/staticContent/JS/jquery.dataTables.js"></script>
<script type="text/javascript" src="/srb/staticContent/JS/jquery.dataTables.tableTools.min.js"></script>
...
<script type="text/javascript">
 	...
 	<script type="text/javascript"> 
		$(document).ready(function () {
	         var table=$("#studentOne").dataTable();
			 var tableTools = new $.fn.dataTable.TableTools(table, {
				 'sSwfPath':'//cdn.datatables.net/tabletools/2.2.4/swf/copy_csv_xls_pdf.swf',
					...
					$(tableTools.fnContainer()).insertBefore('#studentOne_wrapper');
			});
	</script>  
</head>
...
<%-- 
		 ...
		 <div class="form-group row">
                                <div class="col-md-offset-4 col-md-4 btn-center">
                                    <div class="ui buttons">
                                    <input type="button"  class="ui positive button" name="btn" value="Search" onclick="studentListAsPerClassNdDiv()" style="width: 95px;">Save
