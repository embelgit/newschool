...
<%
	...
	try {
		...
		String addclass = (String)session.getAttribute("addclass");
		String officer = (String)session.getAttribute("officer");
		String nirgumclass = (String)session.getAttribute("nirgumclass");
		String nirgumdate = (String)session.getAttribute("nirgumdate");
