...
<html>
	<head>
		...
		<title>Parent Complaint List</title>
  		...
  		<script type="text/javascript">
  			...
  			function Delete()
  			{
  				window.location = "deleteparentcomp.jsp";
  			}
  		</script>
                ...
                <section class="content-header">
                    ...
                    <div class="p-l-30 p-r-30">
                        ...
                        <div class="header-title">
                            <h1>Parents Complaints List</h1>
                            <small>Parents Complaints</small> 
                        </div>
                    </div>
                </section>
    ...
    <div class="col-sm-12">
        <div class="panel panel-default thumbnail">
           ...
           <div class="panel-heading no-print">
                <div class="btn-group"> 
                    <a class="btn btn-primary"  onclick="back()" accesskey="t""> <i class="fa fa-list"></i>Add Complaint</a>  
                </div>
...
<body id="dt_example" style="min-height:300px;">
	...
	<%
		...
		List list12=dao.complaintpaList();
	%>
<div id="demo_jui">

	<div class="table-responsive">
		<table id="list" class="table table-bordered display" border="1">
			<thead>
				<tr>
					<th>Sr no</th>
					<th>Class Name</th>
			...
			<tbody>
   				<%
					...
					for(int i=0;i<list12.size();i++){
						ParentsComplaintHibernate sr=(ParentsComplaintHibernate)list12.get(i);
						k++;
				%>
