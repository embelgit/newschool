...
<%
	...
	try {
		...
		// step 1
		Document document = new Document(PageSize.A5,10,10,20,20);
...
//			table_cell.setPaddingTop(10f);
	...
	/*	table_cell = new PdfPCell(new Phrase(""));
		...
		table_cellThird = new PdfPCell(new Phrase("", Normalfont11));
//		table_cell.setBorder(table_cell.NO_BORDER);
...
//		table_cellThird.setBorder(Rectangle.LEFT | Rectangle.RIGHT);	
//			table_cell.setPaddingTop(10f);
//		table_cellThird.setBorderWidth(1f);
		table_cell.setHorizontalAlignment(Element.ALIGN_CENTER);
		tableThird.addCell(table_cellThird);
...
//			table_cellThird.setBorder(table_cellThird.NO_BORDER);
			table_cellThird.setBorder(Rectangle.LEFT | Rectangle.RIGHT);	
//			table_cellThird.setPaddingLeft(50f);
			table_cellThird.setBorderWidth(1f);
			table_cell.setHorizontalAlignment(Element.ALIGN_CENTER);
			tableThird.addCell(table_cellThird);
		}
