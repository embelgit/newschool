...
<%
	...
	try {
		...
		ResultSet rs = stmt.executeQuery("select Distinct s.first_name,s.middle_name,s.last_name,s.gender from student_master s, sport_certificate d where s.pk_student_id="+studId);
