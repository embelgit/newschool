...
<title>Student Balance Report</title>
                ...
                <section class="content-header">
                    ...
                    <div class="p-l-30 p-r-30">
                        ...
                        <div class="header-title">
                            <h1>Student Fee Balance Reports</h1>
                            <small>Balance Reports</small> 
                        </div>
                    </div>
                </section>
			...
			<div class="row">
				<div class="form-group">	
					<div class="col-md-offset-4 col-md-4 btn-center">
                                    ...
                                    <input type="button" class="ui positive button" name="btn" value="Search" onclick="studentBalanceAsPerClassNdDiv()"  >Save</button>
