...
<head>
 ...
 <script type="text/javascript" src="/srb/staticContent/JS/studentDocument.js"></script>
...
<div class="content-wrapper" style="min-height: 1134px;">
                ...
                <section class="content-header">
                    ...
                    <div class="p-l-30 p-r-30">
                        <div class="header-icon"><img src="/srb/staticContent/Images/file.png" style="width: 55px;"></div>
  ...
  -->
 		...
 		<form class="form-horizontal" name="Stddocuplod">
 				<div class="row">
				<div class="form-group">
					...
					<div class="col-md-3">
						<div class="input-group">
							...
							<input list="classes" id="fk_class_id1" class="form-control" onchange="getDivisionNameByClassNameDocument()">
							<datalist id="classes">
							 <%
...
<%-- 
 			...
 			<div class="form-group">
 				<label class="col-md-2 col-sm-offset-1 control-label"  align="right">Student Name:<sup>*</sup></label>  
						...
						<div class="input-group">
							...
							<select class="form-control input-md" id="fk_Student_id"  name="fk_Student_id" class="form-control" placeholder="Teacher Name">
									</select>
						...
						StudentInfoDao sdd3 = new StudentInfoDao();
							List sList4 = sdd3.getAllMainStudent();
 							...
 							<label class="col-md-2 control-label " align="right">Aadhar Card</label>  
           							 <div class="col-md-3">
										<div class="input-group">
											<span class="input-group-addon">
												<i class="glyphicon glyphicon-file"></i>
											</span>
           									  <input id="aadhar" type="file" class="form-control" name="syllabusFile">
           							 </div>
								</div>
				</div>
			</div>
			...
			<div class="row">
 			<div class="form-group">
 			<label class="col-md-2 control-label col-sm-offset-1 " align="right">Cast Certificate</label>  
           							 <div class="col-md-3">
										<div class="input-group">
											<span class="input-group-addon">
												<i class="glyphicon glyphicon-file"></i>
											</span>
           									 <input id="cast" type="file" class="form-control" name="syllabusFile">
           							 </div>
								</div>
 							<label class="col-md-2 control-label " align="right">Leaving Certificate</label>  
           							 <div class="col-md-3">
										<div class="input-group">
											<span class="input-group-addon">
												<i class="glyphicon glyphicon-file"></i>
											</span>
           									 <input id="lc" type="file" class="form-control" name="syllabusFile">
           							 </div>
								</div>
 			</div>
 			</div>
			...
			<div class="row">
 			<div class="form-group">
 			<label class="col-md-2 control-label col-sm-offset-1 " align="right">Photo</label>  
           							 <div class="col-md-3">
										<div class="input-group">
											<span class="input-group-addon">
												<i class="glyphicon glyphicon-file"></i>
											</span>
           									<input id="studentPhoto" class="form-control" type="file" name="syllabusFile">
           							 </div>
								</div>
 							<label class="col-md-2 control-label " align="right">Extra document</label>  
           							 <div class="col-md-3">
										<div class="input-group">
											<span class="input-group-addon">
												<i class="glyphicon glyphicon-file"></i>
											</span>
           									 <input id="extraDoc" class="form-control" type="file" name="syllabusFile">
           							 </div>
								</div>
 			</div>
 			</div>
			 ...
			 <div class="form-group row">
                                <div class="col-md-offset-4 col-md-4 btn-center">
                                    ...
                                    <input class="ui positive button" name="btn" value="Upload" onclick="uploadStudentScanDocument()" style="width: 95px;">Update
                                       
                                        <div class="or"></div>
                                         <button type="reset" class="ui button" onclick="location.reload()">Reset</button>
                                          <div class="or"></div>
                                          <input class="ui positive button" name="btn" value="Back" onclick="back()" style="width: 95px;">Back
                                         </div>
                                </div>
                            </div>
 </form>
