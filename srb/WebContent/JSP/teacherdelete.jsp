                ...
                <section class="content-header">
                    ...
                    <div class="p-l-30 p-r-30">
                        ...
                        <div class="header-title">
                            ...
                            <small>Delete Teacher Details</small> 
                        </div>
                    </div>
                </section>
        ...
        <div class="panel panel-default thumbnail">
				...
				<div class="row">
	       			 <div class="row form-group">
           				 ...
           				 <label class="col-md-2 control-label col-sm-offset-1">Select Employee Name:</label>  
							 ...
							 <%
							 TeacherInfoDao eedd = new TeacherInfoDao();
           						List mList =eedd.getAllteacher();
				...
				<datalist id="schoolName_drop">
							...
							<%
					           for(int i=0;i<mList.size();i++){
					        	   TeacherInfoHibernate detailsBean =(TeacherInfoHibernate)mList.get(i);
							%>
		
						<option data-value="<%=detailsBean.getPkTeacherId()%>"><%=detailsBean.getFirstName()%> <%=detailsBean.getMiddleName()%> <%=detailsBean.getLastName()%></option>
							<%
				      			}
				    		%>
						</datalist> 
			...
			<div class="form-group row">
                                <div class="col-md-offset-4 col-md-4 btn-center">
                                    ...
                                    <button class="ui positive button" name="btn" value="Delete" onclick="DeleteTechInfo()">Delete</button>
