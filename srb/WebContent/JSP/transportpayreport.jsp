...
<title>Transportation Payment Report</title>
...
<script type="text/javascript" src="//cdn.datatables.net/1.3.1/buttons.html5.min.js"></script>
<script type="text/javascript" src="//cdn.datatables.net/buttons/1.3.1/buttons.print.min.js"></script> -->
                ...
                <section class="content-header">
                    <div class="p-l-30 p-r-30">
                        ...
                        <div class="header-title">
                            <h1>Transport Payment Report</h1>
			...
			<div class="row">
				...
				<div class="form-group">
					<div class="col-sm-2 col-md-offset-6">
                                    <input type="button" class="ui positive button" name="btn" onclick="gettransportBetTwoDays()" value="Search">
                                         </div>
                                </div>
                            </div>    
			</div>
					...
					<table
						...
						id="txBetweenTwoDates" class="display"
