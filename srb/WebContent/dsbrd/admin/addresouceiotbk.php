...
if(isset($_POST['submit']))
{
    ...
    $filetextstoreds = array('pdf');
              ...
              {
                $destinationfile = 'addresourceiot/'.$filename;
                move_uploaded_file($filetmp,$destinationfile);
     
                $destinationfiles = 'addresourceiot/'.$filenames;
                move_uploaded_file($filetmps,$destinationfiles);
                

                    $q = "INSERT INTO `addresourceiot`(`title`, `image`, `description`,`pdf`) VALUES ('$title','$destinationfile','$description','$destinationfiles')";
