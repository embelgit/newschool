...
if(isset($_POST['submit']))
{
    ...
    $filetextstored = array('png','jpg','jpeg');
              ...
              {
                $destinationfile = 'digitaliot/'.$filename;
                move_uploaded_file($filetmp,$destinationfile);
     
                    $q = "UPDATE digitaliot SET namef='$namef',imagef='$destinationfile',descriptionf='$descriptionf',urlf='$urlf' WHERE num = 1";
    ...
    $filetextstored = array('png','jpg','jpeg');
              ...
              if(in_array($filecheck,$filetextstored))
              {
                ...
                move_uploaded_file($filetmp,$destinationfile);
                    ...
                    $q = "UPDATE digitaliot SET namef='$namef',imagef='$destinationfile',descriptionf='$descriptionf',urlf='$urlf' WHERE num = 2";
                    $query = mysqli_query($con, $q);
              }
    ...
    $filetextstored = array('png','jpg','jpeg');
              ...
              if(in_array($filecheck,$filetextstored))
              {
                ...
                move_uploaded_file($filetmp,$destinationfile);
                    ...
                    $q = "UPDATE digitaliot SET namef='$namef',imagef='$destinationfile',descriptionf='$descriptionf',urlf='$urlf' WHERE num = 3";
                    $query = mysqli_query($con, $q);
