...
if(isset($_POST['submit']))
{
    ...
    $filetextstored = array('png','jpg','jpeg');
              ...
              {
                $destinationfile = 'event/'.$filename;
                move_uploaded_file($filetmp,$destinationfile);
     
                    $q = "INSERT INTO `event`(`title`, `image`, `author`, `date`, `url`, `description`,`smallheading`) VALUES ('$title','$destinationfile','$author','$date','$url','$description','$smallheading')";
