...
public class ExpenditurePaymentBean {
	...
	public ExpenditurePaymentBean(Long pkExpPaymentId, Long txId, Long fkExpDetailId, String serviceProvider, Long contactNumber, String accountantName, Double expcredit, Double expDebit, Double totalAmount, Date insertDate, ExpenditureDetailsBean expenditureDetailsBean) {
		super();
		this.pkExpPaymentId = pkExpPaymentId;
		this.txId = txId;
		this.fkExpDetailId = fkExpDetailId;
